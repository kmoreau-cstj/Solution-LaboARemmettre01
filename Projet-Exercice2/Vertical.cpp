// FR : but : déterminer si le nombre a bien 5 chiffres si oui, l'écrir en colone vertical
...
void main()
{
	...
	// KM : Très bien comme condition ...
	if ( nombre > 9999 )
	{
		// KM ... il en faudrait une autre ici pour que le nombre ne dépasse pas 6 chiffres 
